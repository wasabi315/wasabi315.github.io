...
module.exports = function sourceLine() {
  async function transformer(tree, file) {
    ...
    transformElementWithPosition(tree, lineCount)
    transformParagraph(tree)
    transformCodeBlock(tree)
  }
...
function transformElementWithPosition(tree, frontmatterLineCounts) {
...
function transformParagraph(tree) {
